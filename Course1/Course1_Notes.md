...
9. 
   10. **Interview with Nastia Root, Product Manager at Google.** Key points:
   ...
   11. How to have better collaboration and team meetings. As a PM try to achieve the following:
      7. **Sharing Project Visibility:**
      ...
      8. **Monitoring deadlines and releases:** 
      ...
      10. **Deciding what to build and how.**
      11. **Demonstrative software.**
      12. **Improving continuously:** Retrospection is one of the most important practice of a successful inter-disciplinary team. It is not assigning blame, but to identify what could be done better next time.
         3. What went well? 
         4. What could have gone better?
         5. What did we learn?
         6. **What do we want to (keep, change, discard, add) for next iteration?** _- Most important question_ 
   
   12.  **Minimum Viable Agenda (MVA):** of a meeting:
       1.  Questions (Timeboxed)
       2.  Output
       3.  Who and Why - Who needs to be at the meeting and Why.
   
   13.   **Roadmaps:**
       4.  Have a vision of your end-goal.
       5.  Objectives and Key results framework. Tie in your results (product goals) to the companies objectives.
